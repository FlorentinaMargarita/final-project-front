...
let ApiService = class ApiService {
    constructor(_http, _movieService) {
        this._http = _http;
...
let FacvouriteComponent = class FacvouriteComponent {
    constructor(_movieService, _apiService) {
        this._movieService = _movieService;
...
FacvouriteComponent.ctorParameters = () => [
    { type: _movie_service__WEBPACK_IMPORTED_MODULE_3__["MovieService"] },
...
let HeaderComponent = class HeaderComponent {
    constructor(router, _api, _movieService, _userService) {
        this.router = router;
        this._api = _api;
        this._movieService = _movieService;
...
let ResoComponent = class ResoComponent {
    // movie: any;
    constructor(_movieService, _apiService, router, _http) {
        this._movieService = _movieService;
        this._apiService = _apiService;
        this.router = router;
        this._http = _http;
    ...
    ngOnInit() { }
    addToFavorites(movie) {
        this._movieService.addToFavorites(movie).subscribe((res) => {
            console.log(res);
            this.goTofavs();
        });
    }
